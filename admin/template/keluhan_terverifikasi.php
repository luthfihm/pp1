...
$list_keluhan = GetListKeluhanVerified();
$list_kategori = GetAllKategori();

$num_keluhan = GetNumKeluhanVerified();
?>

<section class="panel">
    <header class="panel-heading wht-bg">
        <h4 class="gen-case">Keluhan Terverifikasi
    ...
    <?php }else{ ?>
        <footer class="panel-footer wht-bg">Tidak ada keluhan yang terverifikasi</footer>
    <?php  } ?>
</section>